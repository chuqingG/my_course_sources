set_property SRC_FILE_INFO {cfile:F:/计算机/模数/Nexys4DDR_Master.xdc rfile:F:/计算机/模数/Nexys4DDR_Master.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { Sch=btnc }]; #IO_L9P_T1_DQS_14 Sch=btnc
